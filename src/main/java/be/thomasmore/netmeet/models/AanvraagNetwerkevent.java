...
@Entity
public class AanvraagNetwerkevent {
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "aanvraagNetwerkevent_generator")
    @SequenceGenerator(name = "aanvraagNetwerkevent_generator", sequenceName = "aanvraagNetwerkevent_seq", allocationSize = 1)
    @Id
    private Integer id;
